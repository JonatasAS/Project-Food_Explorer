...
export function ProductItems({ ingredient }) {

  function lookingVisualizationIngredient(name) {
  ...
  let ingredientVisualization = lookingVisualizationIngredient(ingredient)

  return (
    <Container>
      <div className="ingredients">
        <div>
          <img src={ingredientVisualization} alt="Imagem do ingrediente" />
          <p>{ingredient}</p>
        </div>
      </div>
    </Container>
